...
public class QuoteProvider {
    ...
    interface Path {
        ...
        String QUOTES_HISTORICAL = "quotes_historical";
    }
    ...
    public static class QuotesHistorical{
        @ContentUri(
            path = Path.QUOTES_HISTORICAL,
            type =  "vnd.android.cursor.dir/quote_historical"
            )
        public static final Uri CONTENT_URI = buildUri(Path.QUOTES_HISTORICAL);
    }
